...
stopwords = ["ve", "bir","bu","için","ile","de","da","mi","mu", "mı", "mü", 
             ...
             "favori","son", "kimse", "var","yok", "yaptı","etti","bitti","başladı","söyledi","geldi","gitti"
             "her", "tutuklandı", "önemli" ,"şey", "gelişti", "geri", "iyi", "önemli", "yıl", "geri", "dün",
              "verdi", "aldı", "gitti", "dönmedi", "tutuklandı"
               ]
